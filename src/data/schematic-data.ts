...
export const subwayLines = [
  ...
  // LINE 1 — Yonge–University
  {
    ...
    stations: [
      ...
      { id: "stClairWest", name: "St. Clair West", x: -75, y: -40, type: "normal" },
      { id: "eglintonWest", name: "Eglinton West", x: -100, y: -100, type: "normal" },
      { id: "glencairn", name: "Glencairn", x: -100, y: -125, type: "normal" },
      { id: "lawrenceWest", name: "Lawrence West", x: -125, y: -160, type: "normal" },
      { id: "yorkdale", name: "Yorkdale", x: -150, y: -185, type: "normal" },
      { id: "wilson", name: "Wilson", x: -175, y: -210, type: "normal" },
      { id: "sheppardWest", name: "Sheppard West", x: -200, y: -235, type: "normal" },
      { id: "downsviewPark", name: "Downsview Park", x: -225, y: -260, type: "normal" },
      { id: "finchWest", name: "Finch West", x: -250, y: -285, type: "normal" },
      { id: "yorkU", name: "York University", x: -275, y: -310, type: "normal" },
      { id: "pioneerVillage", name: "Pioneer Village", x: -300, y: -335, type: "normal" },
      { id: "highway407", name: "Highway 407", x: -325, y: -360, type: "normal" },
      { id: "vaughan", name: "Vaughan Metropolitan Centre", x: -337.5, y: -400, type: "normal" }
    ]
  }
];
