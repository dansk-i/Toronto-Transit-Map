...
export const subwayLines = [
  // LINE 2 — Bloor–Danforth
  {
    ...
    stations: [
      { id: "kipling", name: "Kipling", x: -475, y: 50, type: "normal" },
      { id: "islington", name: "Islington", x: -425, y: 25, type: "normal" },
      { id: "royalYork", name: "Royal York", x: -400, y: 25, type: "normal" },
      { id: "oldMill", name: "Old Mill", x: -375, y: 25, type: "normal" },
